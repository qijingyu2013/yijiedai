...
(function ($) {
    ...
    var scroller = (function () {
        ...
        scrollerCore.prototype = {
            ...
            _scrollToTopPlus: function (time) {
                this._scrollTo({
                   x: 0,
                   y: 1
                   }, time);
            ...
            _scrollToBottomPlus: function (time) {
            this._scrollTo({
                           x: 0,
                           y: this.el.scrollHeight - this.el.offsetHeight - 1
                           }, time);
            },
            scrollToBottom: function (time) {
                return this._scrollToBottom(time);
            },
            scrollToBottomPlus: function (time) {
                return this._scrollToBottomPlus(time);
            },
            scrollToTop: function (time) {
                return this._scrollToTop(time);
            },
            scrollToTopPlus: function (time) {
                return this._scrollToTopPlus(time);
            },
            //methods
