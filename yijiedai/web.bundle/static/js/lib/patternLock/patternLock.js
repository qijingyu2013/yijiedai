...
;(function () {
    ...
    function readyDom(iObj) {
        ...
        for (var i = 0, ln = matrix[0] * matrix[1]; i < ln; i++) {
            html.push('<li class="patt-circ" style="margin:' + margin + 'px; width : ' + (radius * 2) + 'px; height : ' + (radius * 2) + 'px; -webkit-border-radius: ' + radius + 'px; -moz-border-radius: ' + radius + 'px; border-radius: ' + radius + 'px; "><div class="patt-dots-hidden"></div></li>');
        }
        html.push('</ul>');
        ...
        moveHandler = function (e, obj) {
            ...
            if (idx) {
                if (patternAry.indexOf(pattId) == -1) {
                    ...
                    elm.find("div.patt-dots-hidden").addClass('patt-dots').removeClass('patt-dots-hidden');
